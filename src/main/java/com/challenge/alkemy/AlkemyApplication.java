...
public class AlkemyApplication {
    ...
    public CommandLineRunner initData(CharacterRepository characterRepository,
        ...
        return (args) -> {
            ...
            Character anakin = new Character("anakin.jpg" , "Anakin Skywalker", 23L, 120, "Anakin Skywalker was a Human male born on the Outer Rim world of Tatooine. He later served the Galactic Republic as a Jedi Knight, and later the Galactic Empire as the Sith Lord Darth Vader.");
            Character obiWan = new Character("obiWan.jpg" , "Obi-Wan Kenobi", 57L, 80, "Kenobi was born on the planet Stewjon in 57 BBY. He was Force-sensitive, and therefore taken from his family and inducted into the Jedi Order as a child. Raised in the Jedi Temple on the planet Coruscant, Kenobi was assigned to Jedi Master Qui-Gon Jinn.");
            Character yoda  = new Character("yoda.jpg" , "Yoda ", 900L, 12, "Yoda was a legendary Jedi Master and stronger than most in his connection with the Force. Small in size but wise and powerful, he trained Jedi for over 800 years, playing integral roles in the Clone Wars, the instruction of Luke Skywalker, and unlocking the path to immortality.");
            Character tarzanCharacter  = new Character("tarzan.jpg" , "Tarzan", 18L, 76, "Tarzan is the son of a British lord and lady who were marooned on the coast of Angola by mutineers. When Tarzan was an infant, his mother died, and his father was killed by Kerchak, leader of the ape tribe by whom Tarzan was adopted.");
            Character terk  = new Character("terk.jpg" , "Terk", 17L, 120, "Terkina, or better known as Terk for short, is the niece of Kala and Kerchak, Tarzan's best friend and adoptive cousin.");
            Character cinderellaCharacter  = new Character("cinderella.jpg" , "Cinderella", 19L, 46, "The Cinderella that English speakers know and love can be traced to the French story Cendrillon, first published in 1697 by Charles Perrault, though Chinese and Greek versions of this classic tale go back to the 9th century CE and 6th century BCE, respectively.");
            Character fairy   = new Character("fairy.jpg" , "Fairy Godmother", 600L, 67, "The Fairy Godmother is a supporting character in Disney's 1950 animated feature film, Cinderella. The physical embodiment of hope, she is a kindly fairy that is devoted to making dreams come true for the pure-hearted and noble—an act made possible by proclaiming the magic words, bibbidi-bobbidi-boo.");
            Character pinocchioCharacter  = new Character("pinocchio.jpg" , "Pinocchio", 8L, 25, "Pinocchio was carved by a woodcarver named Geppetto in a Tuscan village. He was created as a wooden puppet but he dreams of becoming a real boy. He is known for his long nose, which (on only one occasion in the novel, but more frequently in most adaptations) grows when he lies.");
            Character jiminy  = new Character("jiminy.jpg" , "Jiminy Cricket", 1L, 25, "Jiminy Cricket is the Walt Disney version of the \"Talking Cricket\" (Italian: Il Grillo Parlante), a fictional character created by Italian writer Carlo Collodi for his 1883 children's book The Adventures of Pinocchio, which Disney adapted into the animated film Pinocchio in 1940.");
            Character aliceCharacter  = new Character("alice.jpg" , "Alice Kingsleigh", 7L, 25, "Alice is the main character from the original books Alice's Adventures in Wonderland and its satisfying sequel, Through the Looking-Glass, and What Alice Found There by Lewis Carroll. She is also prominent in most expansions of the  myths.");
            Character chessur  = new Character("chessur.jpg" , "Chessur", 6L, 15, "Chessur is a cheshire cat who possesses the ability to freely appear and disappear. He is always calm, with a seductive grin that masks his slightly cowardice.");
            Character woody  = new Character("woody.jpg" , "Woody", 70L, 1, "Woody was designed by Bud Luckey, and is based on John Lasseter's Casper pull-string doll he had as a kid, as well as the Howdy Doody puppets from the 1950s show. Woody is named after Woody Strode, a character actor known for many roles in western films.");
            Character buzz  = new Character("buzz.jpg" , "Buzz Lightyear", 1L, 1, "Buzz was created during a time where astronauts were especially popular amongst children. Because of this, his arrival in the original Toy Story created conflict with Andy's favorite toy, Sheriff Woody, though this rivalry would eventually blossom into a lifelong friendship.");
            Character herculesCharacter  = new Character("hercules.jpg" , "Hercules", 20L, 76, "Hercules, son of Hera and the god Zeus, is stolen from Olympus by the minions of Hades to reach Earth and strip him of his immortality. However, the plan does not turn out as expected and the boy still retains some divine powers. During his adolescence, Hercules must prove that he is worthy of ascending to Olympus with the other gods. With the help of the satyr Philoctetes, Hercules will learn to use his strength to fight against a series of evil creatures.");
            Character megara  = new Character("hercules.jpg" , "Hercules", 20L, 56, "Megara (better known as Meg) is the tritagonist of Disney's 1997 animated feature film, Hercules. A snarky \"femme fatale\", Meg once served as a reluctant minion of Hades, to whom she was indebted.");


            Film starWars1 = new Film("STARWARS", "Star wars I", LocalDate.of(1999, 7, 8), 3.8);
            Film starWars2 = new Film("STARWARS", "Star wars II", LocalDate.of(2002, 5, 16), 3.7);
            Film starWars3 = new Film("STARWARS", "Star wars III", LocalDate.of(2005, 5, 19), 4.2);
            Film starWars4 = new Film("STARWARS", "Star wars IV", LocalDate.of(1977, 12, 25), 4.5);
            Film starWars5 = new Film("STARWARS", "Star wars V", LocalDate.of(1980, 7, 31), 4.5);
            Film starWars6 = new Film("STARWARS", "Star wars VI", LocalDate.of(1983, 12, 8), 4.7);
            Film pinocchio = new Film("pinocchio.jpg", "Pinocchio", LocalDate.of(1940, 2, 23), 4.4);
            Film cinderella = new Film("cinderella", "Cinderella", LocalDate.of(1950, 7, 5), 4.3);
            Film alice = new Film("alice-in-wonderland", "Alice in Wonderland", LocalDate.of(1950, 7, 5), 4.3);
            Film toyStory = new Film("toy-story", "Toy Story", LocalDate.of(1996, 3, 14), 4.8);
            Film hercules = new Film("hercules", "Hercules", LocalDate.of(1997, 7, 3), 4.6);
            Film tarzan = new Film("tarzan", "Tarzan", LocalDate.of(1999, 7, 8), 4.8);
            ...
            Genre sciencefiction = new Genre("Sciencefiction.png", "Science fiction");
            Genre adventure = new Genre("adventure.png", "Adventure");
            Genre romantic = new Genre("adventure.png", "Romantic cinema");
            Genre fantasy = new Genre("fantasy.png", "Fantasy");
            Genre musical = new Genre("musical.png", "musical");
